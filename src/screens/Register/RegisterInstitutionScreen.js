            ...
            <SafeAreaView style={{
                ...
                <View className="items-start mt-8 space-y-4">
                    <Text className="text-TextCollector text-lg font-extrabold">
                        <Text className="text-red-600">*</Text> Nombre de institución</Text>
                    <LoginInput />
                    <Text className="text-TextCollector text-lg font-extrabold">
                ...
                <View className="items-center mt-10 space-y-4">
                    ...
                    <LoginButton onPressed={() => navigator.navigate("RegisterInsitutionDetailSc")}
                        TextInput={"Siguiente"}
...
export default RegisterInstitutionScreen
